...
const Contents = () => {
  ...
  const imageChangeHandle = (index, value) => {
  ...
  useEffect(() => {
    if (errorCreate) {
      ...
      toggleIsSmallModal(`Lỗi: ${errorCreate}`);
      setTypeModal("error");
    }
  }, [errorCreate]);
  ...
  return (
    <div className="px-3 mt-5 mb-28">
      ...
      <form
        ...
        className="mt-8 md:px-16 flex flex-col gap-7"
      >
          ...
          <div className="flex items-end gap-3">
            ...
            <div className="flex flex-col items-start gap-2">
              <label
                ...
                className={`cursor-pointer px-3 py-1.5 hover:opacity-80 flex items-center ${
                  thumbImage ? "border border-gray-300" : "bg-black"
                }`}
              >
                {thumbImage ? (
                  ...
                  <>
                    <span className="text-sm text-white">Tải ảnh mới</span>
                    <AiOutlineCloudUpload className="ml-1.5 text-lg text-white" />
                  </>
                )}
              </label>
              <input
              ...
              />
              <span className="text-xs text-nowrap">Yêu cầu ảnh tỷ lệ 2/3</span>
            </div>
          </div>
        </fieldset>
                  ...
                  <tr key={i} className="border border-gray-300">
                    ...
                    <td className="border-r border-gray-300 w-full p-3">
                      <textarea
                        ...
                        onChange={(e) => imageChangeHandle(i, e.target.value)}
                        maxLength={100}
                      ></textarea>
                    </td>
                    <td className="text-center border-r border-gray-300">
                ...
                {sizes.map((item, i) => (
                  <tr key={i} className="border border-gray-300">
                    ...
                    <td className="text-center">
                      <button type="button" onClick={() => removeSizeHandle(i)}>
                        <RiDeleteBin6Line className="text-red-500" />
                      </button>
                    </td>
                  </tr>
        ...
        <div className="mt-2 flex justify-end">
          <button
            ...
            className={`text-sm bg-black text-white px-3 py-1.5 hover:opacity-80 ${
              LoadingCreate && "bg-opacity-30 pointer-events-none"
            }`}
          >
            {LoadingCreate ? "Đang tạo..." : "Tạo"}
          </button>
        </div>
      </form>
